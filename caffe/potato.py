...
def classify(name):
  root = '/home/dns55/potato/JPG-PNG-to-MNIST-NN-Format/test-images/'
  
  image = caffe.io.load_image(root + name)
...
for i in range(1, 11):
  print "Should be potato: ", classify('potato%d.jpg' % i)
  print "Should be not potato: ", classify('notpotato%d.jpg' % i)
